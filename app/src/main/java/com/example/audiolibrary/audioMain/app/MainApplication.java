...
public class MainApplication extends com.example.audiolibrary.androidlibrary.app.MainApplication {
    public static final String PREFERENCE_STORAGE = "storage_path";
    public static final String PREFERENCE_AUDIOFORMAT = "audioformat";
    ...
    public static int getTheme(Context context, int light, int dark) {
        return com.example.audiolibrary.androidlibrary.app.MainApplication.getTheme(context, PREFERENCE_THEME, light, dark);
    }
