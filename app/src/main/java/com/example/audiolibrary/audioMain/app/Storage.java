...
public class Storage extends com.example.audiolibrary.androidlibrary.app.Storage {
    ...
    public static long average(Context context, int format, long free) { // get average recording miliseconds based on compression format
        ...
        long perSec = Factory.getEncoderRate(format, ext, rate) * m;
    ...
    @Override
    public void migrateLocalStorage() throws FileNotFoundException {
    ...
    public void migrateLocalStorage(File l) throws FileNotFoundException {
        if (l == null)
            return;
    ...
    public Uri migrate(File f, Uri t) throws FileNotFoundException {
        Uri u = com.example.audiolibrary.androidlibrary.app.Storage.migrate(context, f, t);
        if (u == null)
            return null;
    ...
    public Uri rename(Uri f, String t) throws FileNotFoundException {
        Uri u = com.example.audiolibrary.androidlibrary.app.Storage.rename(context, f, t);
        if (u == null)
            return null;
