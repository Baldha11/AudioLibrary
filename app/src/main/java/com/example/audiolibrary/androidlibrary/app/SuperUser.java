package com.example.audiolibrary.androidlibrary.app;
...
import com.example.audiolibrary.androidlibrary.widgets.ErrorDialog;
...
public class SuperUser {
    ...
    public FileDescriptor dup(FileDescriptor fd) {
        try {
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                @SuppressLint("BlockedPrivateApi") Method m = Os.getDeclaredMethod("dup", FileDescriptor.class);
    ...
    public static String strerror(int errno) {
        try {
            ...
            @SuppressLint("BlockedPrivateApi") Method m = ForwardingOs.getDeclaredMethod("strerror", int.class);
    ...
    public static class VirtualFile extends Directory { // has no information about attrs (size, last, exists)
        boolean exists;
