package com.example.audiolibrary.androidlibrary.activities;
...
import com.example.audiolibrary.androidlibrary.widgets.RemoteViewsCompat;
...
public abstract class AppCompatThemeActivity extends AppCompatActivity {
    ...
    public abstract boolean onPreferenceDisplayDialog(PreferenceFragmentCompat caller, Preference pref);
    ...
    public int getAppThemeBar(Toolbar toolbar) { // old api, need to set theme excplitly for toolbar
        ...
        if (parent instanceof ViewGroup) { // AppBarLayout
            ...
            if (t instanceof ContextThemeWrapper) {
                return ((ContextThemeWrapper) t).getThemeResId();
            }
        }
        return 0;
    }
