package com.example.audiolibrary.androidlibrary.preferences;
...
import com.example.audiolibrary.androidlibrary.app.AlarmManager;
import com.example.audiolibrary.androidlibrary.app.NotificationManagerCompat;
import com.example.audiolibrary.androidlibrary.app.Storage;
import com.example.audiolibrary.androidlibrary.widgets.NotificationChannelCompat;
import com.example.audiolibrary.androidlibrary.widgets.RemoteNotificationCompat;
import com.example.audiolibrary.androidlibrary.widgets.ThemeUtils;
import com.example.audiolibrary.androidlibrary.widgets.Toast;
...
//        return h;
    ...
    public static Context themedContext(Context context) {
        ...
        context.getTheme().resolveAttribute(androidx.appcompat.R.attr.theme, tv, true);
    ...
    public static void build(final WarningBuilder builder, String msg, DialogInterface.OnClickListener click) {
        ...
        if (ICON) {
            ...
            TextViewCompat.setTextAppearance(desc, R.style.TextAppearance_Toast);
            desc.setText(msg);
            ll.addView(desc);
    ...
    public static class PersistentIconBuilder extends RemoteNotificationCompat.Low {
        ...
        public PersistentIconBuilder create(int theme, NotificationChannelCompat channel) {
            ...
            setTheme(theme)
                    .setChannel(channel)
                    .setImageViewTint(R.id.icon_circle, getThemeColor(R.color.colorPrimary))
